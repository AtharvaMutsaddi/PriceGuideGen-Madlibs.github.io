...
submitbtn.addEventListener('click', function(){
   ...
   <br>
    ...
    •	Premium grade dry dog food will cost around $516 per month (around ${Math.round(eval(document.getElementById('expfood').value)/eval(document.getElementById('monthfoodreq').value))} per pound)
